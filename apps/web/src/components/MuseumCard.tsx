...
export default function MuseumCard({ museum, userData }: MuseumCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 w-full h-28 z-10 pointer-events-none" style={{background: `linear-gradient(to top, ${COLORS.overlay} 60%, rgba(0,0,0,0.15) 90%, rgba(0,0,0,0.0) 100%)`}} />
